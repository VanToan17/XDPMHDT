...
class AppColors {
  ...
  static const bgSecondayLight = Color.fromRGBO(245, 247, 250, 1);
  ...
  static const primary = Color.fromRGBO(9, 73, 137, 1);
  static const primaryPurple = Color(0xFF8E59FF);
  static const success = Color(0xFF83BF6E);
  static const error = Color(0xFFFF6A55);
  static const warning = Color.fromRGBO(225, 93, 0, 1);
  static const danger = Color(0xFFFF6A55);
